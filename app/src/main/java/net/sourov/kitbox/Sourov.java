...
public class Sourov {
    ...
    DatabaseReference adminInfoRef, userRef;
    Context context;
    ...
    public Sourov(Context context) {
        ...
        adminInfoRef = FirebaseDatabase.getInstance().getReference().child("administrator");
        if (firebaseAuth.getCurrentUser()!=null){
            userRef = FirebaseDatabase.getInstance().getReference().child("user").child(Objects.requireNonNull(firebaseAuth.getUid()));
            userRef.keepSynced(true);
        }

        adminInfoRef.keepSynced(true);
    ...
    public DatabaseReference getAdminInfoRef() {
        return adminInfoRef;
    }
    ...
    public void checkUpdate() {
        ...
        adminInfoRef.child("latest_version").addValueEventListener(new ValueEventListener() {
            @Override
    ...
    private void showUpdateAlertDialog() {
        ...
        builder1.setPositiveButton("Yes", (dialog, id) -> getTheDownloadLink());
    ...
    private void getTheDownloadLink() {
        adminInfoRef.child("latest_version_link").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
        ...
        userRef.child("points").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                try {
                    ...
                    e.printStackTrace();
                    userRef.child("points").setValue(100);
                }
        ...
        userRef.child("points").addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (jog_na_biyog.equals("jog")) {
                    userRef.child("points").setValue(currentPt + pointsTOChange);
                }
    ...
    public void showPointPopup() {
        ...
        pointDialogView.findViewById(R.id.getMoreCoin).setOnClickListener(view -> {
            spinner().show();
            loadAds();
        });
    ...
    private void loadAds() {
        RewardedAd.load(context, context.getString(R.string.rewardedAdsCode),
